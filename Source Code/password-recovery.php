...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "select Admin_ID from admin where UserName='$username' and MobileNumber='$contactno' ");

    $ret = mysqli_num_rows($query);
    if ($ret > 0) {
        $query1 = mysqli_query($con, "update admin set Password='$password'  where  UserName='$UserName' && MobileNumber='$contactno' ");
        if ($query1) {
...
<head>
    ...
    <title>Get Vaccinated! | Admin Login</title>
