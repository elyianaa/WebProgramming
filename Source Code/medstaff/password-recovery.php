...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "select staff_id from medicalstaff where UserName='$username' and PhoneNumber='$contactno' ");

    $ret = mysqli_num_rows($query);
    if ($ret > 0) {
        $query1 = mysqli_query($con, "update medicalstaff set Password='$password'  where  UserName='$username' && PhoneNumber='$contactno' ");
        if ($query1) {
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                <h3 align="center" style="margin-top:4%;color:#fff">Get Vaccinated! Password Recovery </h3>
