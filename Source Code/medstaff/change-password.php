...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "select staff_id from medicalstaff where staff_id='$staffid' and  Password='$cpassword'");
        $row = mysqli_fetch_array($query);
        if ($row > 0) {
            $ret = mysqli_query($con, "update medicalstaff set Password='$newpassword' where staff_id='$staffid'");
...
?>
    ...
    <head>
        ...
        <title>Medical Staff | Change Password</title>
